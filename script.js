...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            submitBtn.textContent = '🚀 Отправляем в AI...';
            submitBtn.disabled = true;
            
            setTimeout(() => {
                showNotification('Спасибо! Ваше сообщение получено AI! ✨', 'success');
                this.reset();
...
function activateEasterEgg() {
    showNotification('🎉 Конами-код активирован! AI одобряет! 🤖', 'success');
